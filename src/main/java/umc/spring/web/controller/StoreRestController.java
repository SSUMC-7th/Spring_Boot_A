...
public class StoreRestController {
    ...
    public ApiResponse<StoreResponseDTO.ReviewPreViewListDTO> getReviewList(@ExistRestaurant @PathVariable(name = "storeId") Long storeId,@RequestParam(name = "page") Integer page){
        Page<user_review> reviewList = storeQueryService.getReviewList(storeId,page);
    ...
    public ApiResponse<StoreResponseDTO.MissionPreViewListDTO> getMissionList(@ExistRestaurant @PathVariable(name = "storeId") Long storeId,@RequestParam(name = "page") Integer page){
