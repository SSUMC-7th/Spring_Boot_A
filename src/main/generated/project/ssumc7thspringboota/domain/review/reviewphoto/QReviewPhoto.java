...
public class QReviewPhoto extends EntityPathBase<ReviewPhoto> {
    ...
    private static final long serialVersionUID = -827973383L;
    ...
    public final project.ssumc7thspringboota.domain.review.QReview review;
    ...
    public QReviewPhoto(Class<? extends ReviewPhoto> type, PathMetadata metadata, PathInits inits) {
        ...
        this.review = inits.isInitialized("review") ? new project.ssumc7thspringboota.domain.review.QReview(forProperty("review"), inits.get("review")) : null;
    }
