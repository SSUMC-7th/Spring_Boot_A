...
public class QInquiry extends EntityPathBase<Inquiry> {
    ...
    private static final long serialVersionUID = -1499922025L;
    ...
    public final SetPath<project.ssumc7thspringboota.domain.inquiry.inquiryphoto.InquiryPhoto, project.ssumc7thspringboota.domain.inquiry.inquiryphoto.QInquiryPhoto> inquiryPhotos = this.<project.ssumc7thspringboota.domain.inquiry.inquiryphoto.InquiryPhoto, project.ssumc7thspringboota.domain.inquiry.inquiryphoto.QInquiryPhoto>createSet("inquiryPhotos", project.ssumc7thspringboota.domain.inquiry.inquiryphoto.InquiryPhoto.class, project.ssumc7thspringboota.domain.inquiry.inquiryphoto.QInquiryPhoto.class, PathInits.DIRECT2);
